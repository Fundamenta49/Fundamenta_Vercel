...
const MortgageEducation: React.FC = () => {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Conventional Loans</h4>
              ...
              <div className="flex gap-2 mt-2">
                <Badge variant="outline">Higher credit requirements</Badge>
                <Badge variant="outline">Usually requires 3-20% down</Badge>
              </div>
            </div>
            
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">FHA Loans</h4>
              <p className="text-sm mt-1">
                Insured by the Federal Housing Administration. Designed for borrowers with lower credit scores or smaller down payments.
              </p>
              <div className="flex gap-2 mt-2">
                <Badge variant="outline">Lower credit requirements</Badge>
                <Badge variant="outline">Down payment as low as 3.5%</Badge>
                <Badge variant="outline">Mortgage insurance required</Badge>
              </div>
            </div>
            
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">VA Loans</h4>
              <p className="text-sm mt-1">
                Guaranteed by the Department of Veterans Affairs. Available to eligible service members, veterans, and their spouses.
              </p>
              <div className="flex gap-2 mt-2">
                <Badge variant="outline">No down payment required</Badge>
                <Badge variant="outline">No mortgage insurance</Badge>
                <Badge variant="outline">Limited to eligible veterans</Badge>
              </div>
            </div>
            
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">USDA Loans</h4>
              <p className="text-sm mt-1">
                Guaranteed by the U.S. Department of Agriculture. Designed for rural and some suburban homebuyers.
              </p>
              <div className="flex gap-2 mt-2">
                <Badge variant="outline">No down payment required</Badge>
                <Badge variant="outline">Income limits apply</Badge>
                <Badge variant="outline">Rural/suburban areas only</Badge>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Fixed-Rate Mortgages</h4>
            ...
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Adjustable-Rate Mortgages (ARMs)</h4>
              <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="relative border-l-2 border-muted-foreground/30 pl-6 pb-2 space-y-6">
            <div className="relative">
              <div className="absolute -left-[30px] top-0 h-6 w-6 rounded-full bg-primary flex items-center justify-center text-xs text-primary-foreground font-bold">1</div>
              <h4 className="font-medium">Check Your Credit</h4>
              <p className="text-sm mt-1">
            ...
            <div className="relative">
              <div className="absolute -left-[30px] top-0 h-6 w-6 rounded-full bg-primary flex items-center justify-center text-xs text-primary-foreground font-bold">2</div>
              <h4 className="font-medium">Determine Your Budget</h4>
              <p className="text-sm mt-1">
            ...
            <div className="relative">
              <div className="absolute -left-[30px] top-0 h-6 w-6 rounded-full bg-primary flex items-center justify-center text-xs text-primary-foreground font-bold">3</div>
            ...
            <div className="relative">
              <div className="absolute -left-[30px] top-0 h-6 w-6 rounded-full bg-primary flex items-center justify-center text-xs text-primary-foreground font-bold">4</div>
              <h4 className="font-medium">Shop for a Home & Make an Offer</h4>
              <p className="text-sm mt-1">
            ...
            <div className="relative">
              <div className="absolute -left-[30px] top-0 h-6 w-6 rounded-full bg-primary flex items-center justify-center text-xs text-primary-foreground font-bold">5</div>
              <h4 className="font-medium">Loan Processing & Underwriting</h4>
              <p className="text-sm mt-1">
            ...
            <div className="relative">
              <div className="absolute -left-[30px] top-0 h-6 w-6 rounded-full bg-primary flex items-center justify-center text-xs text-primary-foreground font-bold">6</div>
              <h4 className="font-medium">Closing</h4>
              <p className="text-sm mt-1">
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Personal Factors</h4>
              <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium flex items-center gap-2">
                <div className="h-5 w-5 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-xs font-bold">P</div>
                Principal
              </h4>
              <p className="text-sm mt-1">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium flex items-center gap-2">
                <div className="h-5 w-5 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-xs font-bold">I</div>
                Interest
              </h4>
              <p className="text-sm mt-1">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium flex items-center gap-2">
                <div className="h-5 w-5 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-xs font-bold">T</div>
                Taxes
              </h4>
              <p className="text-sm mt-1">
          ...
          <div className="bg-muted p-4 rounded-lg space-y-3">
            ...
            <div>
              <h4 className="font-medium">Home Improvements</h4>
              <p className="text-sm mt-1">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Lower Your Interest Rate</h4>
              <p className="text-sm mt-1">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Change Your Loan Term</h4>
              <p className="text-sm mt-1">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Switch Loan Types</h4>
              <p className="text-sm mt-1">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Cash-Out Refinance</h4>
              <p className="text-sm mt-1">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Remove PMI</h4>
              <p className="text-sm mt-1">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <h4 className="font-medium">Consolidate Debt</h4>
              <p className="text-sm mt-1">
          ...
          <div className="bg-muted p-4 rounded-lg">
            <h4 className="font-medium">Break-Even Point Analysis</h4>
            <p className="text-sm mt-1">
  ...
  const getDifficultyBadge = (difficulty: 'beginner' | 'intermediate' | 'advanced') => {
    switch (difficulty) {
      case 'beginner':
        return <Badge className="bg-green-100 text-green-800 hover:bg-green-100 border-green-300">Beginner</Badge>;
      case 'intermediate':
        return <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-100 border-blue-300">Intermediate</Badge>;
      case 'advanced':
        return <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-100 border-purple-300">Advanced</Badge>;
    }
  };
        ...
        <CardContent className="pt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {mortgageGuides.map((guide) => (
              <Card key={guide.id} className="border shadow-sm hover:shadow transition-shadow">
          ...
          <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <h4 className="font-medium">Pre-Qualification</h4>
                    <ul className="list-disc pl-5 space-y-1 text-sm">
              ...
              <AccordionContent>
                <div className="space-y-3">
                  ...
                  <div className="bg-muted p-3 rounded">
                    <h4 className="font-medium">Fixed-Rate Mortgage Might Be Better If:</h4>
                  ...
                  <div className="bg-muted p-3 rounded">
                    <h4 className="font-medium">Adjustable-Rate Mortgage (ARM) Might Be Better If:</h4>
                    <ul className="list-disc pl-5 mt-1 space-y-1 text-sm">
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                ...
                <div className="space-y-2">
                  <h4 className="font-medium">When to Consider Paying Points:</h4>
                  <ul className="list-disc pl-5 space-y-1 text-sm">
                  ...
                  <h4 className="font-medium">When to Avoid Paying Points:</h4>
                  <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <AccordionItem value="item-6">
              ...
              <AccordionContent>
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-muted p-3 rounded">
                      <h4 className="font-medium">Income Documentation</h4>
                      <ul className="list-disc pl-5 mt-1 space-y-1 text-sm">
                    ...
                    <div className="bg-muted p-3 rounded">
                      <h4 className="font-medium">Asset Documentation</h4>
                      <ul className="list-disc pl-5 mt-1 space-y-1 text-sm">
                    ...
                    <div className="bg-muted p-3 rounded">
                      <h4 className="font-medium">Debt & Liability Documentation</h4>
                      <ul className="list-disc pl-5 mt-1 space-y-1 text-sm">
                    ...
                    <div className="bg-muted p-3 rounded">
                      <h4 className="font-medium">Personal Documentation</h4>
                      <ul className="list-disc pl-5 mt-1 space-y-1 text-sm">
                  ...
                  <div className="bg-muted p-3 rounded">
                    <h4 className="font-medium">Property Information (once you've found a home)</h4>
                    <ul className="list-disc pl-5 mt-1 space-y-1 text-sm">
