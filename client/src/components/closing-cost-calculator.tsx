        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              <Label htmlFor="advanced-mode" className="cursor-pointer flex items-center gap-1">
          ...
          <Tabs defaultValue="purchase" onValueChange={handleTabChange} className="mb-6">
            ...
            <TabsContent value="purchase" className="pt-4">
              <EnhancedScrollArea className="max-h-[70vh] overflow-y-auto dialog-scroll-container pr-4 pb-4">
