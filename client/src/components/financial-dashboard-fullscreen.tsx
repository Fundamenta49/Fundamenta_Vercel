...
interface FinancialDashboardFullscreenProps {
  budgetData: BudgetData | null;
  onClose: () => void;
}

/**
 * Fullscreen Financial Dashboard - Complete replacement that ensures proper fullscreen display
 */
export default function FinancialDashboardFullscreen({ 
  budgetData, 
  onClose 
}: FinancialDashboardFullscreenProps) {
