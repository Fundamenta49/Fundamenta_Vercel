...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ...
      // The following props are supported by Radix UI Toast primitive
      {...props}
    />
  )
})
