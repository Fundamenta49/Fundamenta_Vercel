...
interface MortgageCalculatorFullscreenProps {
  onClose: () => void;
}

const MortgageCalculatorFullscreen: React.FC<MortgageCalculatorFullscreenProps> = ({ onClose }) => {
      ...
      <div className="flex justify-between items-center px-6 py-4 border-b bg-gradient-to-r from-green-600 to-emerald-500 text-white">
        <div>
          ...
          <p className="text-green-100">
            Calculate monthly payments, amortization schedule, and total interest
          </p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <Alert variant="default" className="mb-6 border-green-500 bg-green-50">
          ...
          <AlertDescription className="text-green-800 text-sm">
            Make changes to any input to see how your monthly payment and total costs change. All calculations use real-time mortgage rates from the Federal Reserve.
          </AlertDescription>
        </Alert>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className={loanTerm === 30 ? "flex-1 bg-green-600 hover:bg-green-700" : "flex-1"}
                >
                  30 Years
                </Button>
                <Button
                  ...
                  className={loanTerm === 15 ? "flex-1 bg-green-600 hover:bg-green-700" : "flex-1"}
                >
                  15 Years
                </Button>
              </div>
        ...
        {mortgageResult && (
          <div className="mt-8">
            <h3 className="text-xl font-bold mb-4">Mortgage Results</h3>
...
export default MortgageCalculatorFullscreen;