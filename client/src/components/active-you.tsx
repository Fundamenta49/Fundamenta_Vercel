...
import {
  Dumbbell,
  Bird as YogaIcon, // Using Bird as a replacement for Yoga
  Timer as RunningIcon, // Using Timer as a replacement for Running
  Brain,
  CalendarDays,
  Timer,
  TrendingUp,
...
export default function ActiveYou() {
    ...
    <div className="space-y-6">
      <Tabs defaultValue="meditation">
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="weightlifting" className="flex items-center gap-2">
            <Dumbbell className="h-4 w-4" />
            Weight Lifting
          </TabsTrigger>
          <TabsTrigger value="yoga" className="flex items-center gap-2">
            <YogaIcon className="h-4 w-4" />
            Yoga
          </TabsTrigger>
