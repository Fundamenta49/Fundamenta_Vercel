...
import { Save, FileText, Download, Trash, Plus, PenLine } from 'lucide-react';
import { 
  PDFDownloadLink, 
  Document, 
  Page, 
...
const formSchema = z.object({
  personalInfo: z.object({
    ...
    summary: z.string().max(500, { message: "Summary should be at most 500 characters." }).optional(),
  }),
  experience: z.array(
    z.object({
...
const ResumePDF = ({ data }: { data: FormValues }) => (
  <Document>
        ...
        <div className="border rounded-lg p-8 bg-white dark:bg-gray-900 shadow-md">
          <div className="mb-8">
            <h1 className="text-3xl font-bold">
              {form.getValues("personalInfo.fullName") || "Your Name"}
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              {form.getValues("personalInfo.jobTitle") || "Your Job Title"}
            </p>
