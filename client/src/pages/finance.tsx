...
export default function Finance() {
  ...
  return (
    <div className="w-full h-full mx-auto p-0">
      ...
      <div className="px-2">
        <div className="mb-4">
          <div className="pb-4 mb-6 border-b border-green-500">
              ...
              >
                ...
                >
                  ...
                  <div className={`flex flex-col ${section.id === 'bank' ? 'sm:items-start items-center' : 'items-center'} w-full`}>
                    <span 
                      className={`text-sm sm:text-base md:text-lg font-medium ${section.id === 'bank' ? 'sm:text-left text-center' : 'text-center'} line-clamp-2 w-full text-green-500`}
                    >
                      {section.title}
                    </span>
