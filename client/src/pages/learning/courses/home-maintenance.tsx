...
export default function HomeMaintenanceCourse() {
  ...
  return (
    <div className="container mx-auto px-0 sm:px-4 py-6 max-w-6xl relative">
      ...
      {/* Banner card - Standardized with Yoga-style UI with light orange accent */}
      <div className="w-full sm:px-0 mb-6 px-4">
        <Card className="border-0 shadow-sm rounded-none sm:rounded-2xl overflow-hidden w-full">
          ...
          <div className="h-1.5 bg-gradient-to-r from-orange-300 via-orange-400 to-orange-300"></div>
