          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-5 mt-4">
            <div className="flex flex-col h-full">
              ...
              >
                ...
                <span className="text-sm sm:text-base font-medium text-center line-clamp-2 w-full">Calendar</span>
                
                <p className="text-xs text-gray-500 mt-1 line-clamp-2 text-center hidden sm:block">
                  View and manage all your scheduled activities and learning goals
                </p>
              </button>
            </div>
          </div>
