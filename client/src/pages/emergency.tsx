  ...
  return (
    <div className="w-full h-full mx-auto p-0">
      ...
      <div className="px-4 sm:px-6">
        <div className="mb-8">
          <h2 className="text-xl font-bold mb-4 px-2 py-2 bg-red-50 text-red-800 rounded-md border-l-4 border-red-500">
            Emergency Resources
          </h2>
            ...
            {SECTIONS.map((section) => (
              <div key={section.id} className="flex flex-col">
                <button
                  ...
                  className="relative flex flex-col items-center justify-between p-2 rounded-lg border bg-white shadow-sm transition-all duration-200 hover:shadow-md hover:border-red-500 min-h-[68px] sm:min-h-[85px] w-full"
